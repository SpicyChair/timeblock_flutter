...
class GridPlannerDrag extends StatefulWidget {
  const GridPlannerDrag({Key? key}) : super(key: key);

  @override
  State<GridPlannerDrag> createState() => _GridPlannerDragState();
}

class _GridPlannerDragState extends State<GridPlannerDrag> {
        ...
        return StatefulBuilder(builder: (context, setState) {
          return AlertDialog(
            ...
            actions: <Widget>[
              ...
              ElevatedButton(
                onPressed: () {
                  Provider.of<ActivityBase>(context, listen: false).createNewActivity(newActivityName, currentColor);
                  Navigator.of(context).pop();
                },
                child: const Text('Create Activity'),
              ),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: gridviewController.value == const Selection.empty()
          ? Container()
          : Column(
              ...
              children: [
                FloatingActionButton(
                  onPressed: () {
                    showSavedActivitySelectionDialog();
                  },
                ...
                FloatingActionButton(
                  onPressed: () => removeActivityFromSelectedIntervals(),
                  foregroundColor: Colors.white,
